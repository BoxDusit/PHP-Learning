        ...
        <div class="container">
            ...
            <div class="ms-auto">
                <?php if (isset($_SESSION['role'])): ?>
                    ...
                    <?php else: ?>
                        <span class="text-white-50 me-3 small">ACCESS LEVEL: USER</span>
                        <button class="btn btn-outline-danger rounded-pill px-4" onclick="location.href='logout.php'">
                            LOGOUT
                        </button>
                    <?php endif; ?>

                <?php else: ?>
                    <button class="btn btn-outline-light rounded-pill px-4" data-bs-toggle="modal" data-bs-target="#loginModal">
                        LOGIN
                    </button>
                <?php endif; ?>
            </div>
